...
export default function CreatePost() {
    ...
    const avatar = profile?.avatar || txtImg.src;
    ...
    return (
        <>
            <div className="_mar_b16" style={{ height: "18px" }}></div>
            ...
            <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
                ...
                {previewUrl && (
                    <div className="_mar_t16">
                        <img src={previewUrl} alt="Selected preview" className="img-fluid _b_radious6" />
                    </div>
                )}
                            ...
                            >
                                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
                                        <path fill="#666" d="M13.917 0c3.108 0 5.18 2.428 5.18 5.914v8.17c0 3.486-2.072 5.916-5.18 5.916H5.999C2.89 20 .827 17.572.827 14.085v-8.17C.827 2.43 2.897 0 6 0h7.917zm0 1.504H5.999c-2.321 0-3.799 1.735-3.799 4.41v8.17c0 2.68 1.472 4.412 3.799 4.412h7.917c2.328 0 3.807-1.734 3.807-4.411v-8.17c0-2.678-1.478-4.411-3.807-4.411zm.65 8.68l.12.125 1.9 2.147a.803.803 0 01-.016 1.063.642.642 0 01-.894.058l-.076-.074-1.9-2.148a.806.806 0 00-1.205-.028l-.074.087-2.04 2.717c-.722.963-2.02 1.066-2.86.26l-.111-.116-.814-.91a.562.562 0 00-.793-.07l-.075.073-1.4 1.617a.645.645 0 01-.97.029.805.805 0 01-.09-.977l.064-.086 1.4-1.617c.736-.852 1.95-.897 2.734-.137l.114.12.81.905a.587.587 0 00.861.033l.07-.078 2.04-2.718c.81-1.08 2.27-1.19 3.205-.275zM6.831 4.64c1.265 0 2.292 1.125 2.292 2.51 0 1.386-1.027 2.511-2.292 2.511S4.54 8.537 4.54 7.152c0-1.386 1.026-2.51 2.291-2.51zm0 1.504c-.507 0-.918.451-.918 1.007 0 .555.411 1.006.918 1.006.507 0 .919-.451.919-1.006 0-.556-.412-1.007-.919-1.007z" />
                                    </svg>
                                </span>
                                Photo
                            </button>
                            ...
                            <button type="button" className="_feed_inner_text_area_bottom_photo_link">
                                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="24" fill="none" viewBox="0 0 21 24">
                                        <path fill="#666" d="M13.94 2c.32 0 .584.263.627.603l.005.095v.895c2.514.22 4.048 2.095 4.048 5.104v8.034c0 3.317-1.817 5.269-4.75 5.269H6.45c-2.938 0-4.75-1.905-4.75-5.15V8.697c0-3.008 1.537-4.883 4.048-5.104v-.895c0-.385.283-.698.632-.698.32 0 .585.263.627.603l.005.095v.875h6.295v-.875c0-.385.283-.698.632-.698zm3.412 8.579H2.967v6.271c0 2.399 1.238 3.755 3.482 3.755h7.421c2.24 0 3.482-1.4 3.482-3.874v-6.152zM14.394 16c.35 0 .632.312.632.698 0 .354-.237.645-.546.692l-.086.005c-.357 0-.64-.312-.64-.697 0-.354.237-.645.546-.692l.094-.006zm-4.234 0c.349 0 .632.312.632.698 0 .354-.238.645-.546.692l-.086.005c-.357 0-.64-.312-.64-.697 0-.354.237-.645.546-.692L10.16 16zm-4.234 0c.35 0 .632.312.632.698 0 .354-.238.645-.546.692l-.086.005c-.357 0-.64-.312-.64-.697 0-.354.237-.645.546-.692L5.926 16zm8.468-3.789c.35 0 .632.312.632.698 0 .354-.237.645-.546.692l-.086.005c-.357 0-.64-.312-.64-.697 0-.354.237-.645.546-.692l.094-.006zm-4.234 0c.349 0 .632.312.632.698 0 .354-.238.645-.546.692l-.086.005c-.357 0-.64-.312-.64-.697 0-.354.237-.645.546-.692l.094-.006zm-4.234 0c.35 0 .632.312.632.698 0 .354-.238.645-.546.692l-.086.005c-.357 0-.64-.312-.64-.697 0-.354.237-.645.546-.692l.094-.006zm7.381-7.243H7.012v.964c0 .385-.283.697-.632.697-.32 0-.585-.262-.627-.603l-.005-.094v-.944c-1.81.195-2.781 1.489-2.781 3.709v.487h14.385v-.487c0-2.242-.958-3.512-2.78-3.709v.944c0 .385-.283.697-.633.697-.32 0-.584-.262-.626-.603l-.006-.094v-.964z" />
                                    </svg>
                                </span>
                                Event
                            </button>
