...
import friendReqImg from "@/assets/images/friend-req.png";
import profileOneImg from "@/assets/images/profile-1.png";
                                        ...
                                        <div className="_notifications_drop_box">
                                            ...
                                            <div className="_notifications_all">
                                                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((item) => (
                                                    <div className="_notification_box" key={item}>
                                                        <div className="_notification_image">
                                                            <img src={item % 2 === 0 ? profileOneImg.src : friendReqImg.src} alt="Image" className="_notify_img" />
                                                        </div>
                                ...
                                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <div className="_header_mobile_menu_top_inner">
                                        <div className="_header_mobile_menu_logo">
                                            <a href="/feed" clas="_mobile_logo_link">
                                                <img src={logo.src} alt="Image" className="_nav_logo" />
                                            </a>
                                        </div>
